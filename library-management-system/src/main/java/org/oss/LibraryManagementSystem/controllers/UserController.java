...
public class UserController {
    ...
    public String editUser(@PathVariable("id") Integer id, Authentication authentication, Model model) {
        ...
        if (
                currentUserRoles.contains(new SimpleGrantedAuthority("LIBRARIAN")) && user.getRoles().contains(roleRepository.findByName("MEMBER"))
                || currentUserRoles.contains(new SimpleGrantedAuthority("ADMIN"))
        ) {
